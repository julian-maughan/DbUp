...
namespace DbUp.Tests
{
    ...
    public class SqlScriptExecutorTests
    {
        ...
        {
            var executor = new SqlServerScriptExecutor(() => Substitute.For<IConnectionManager>(), () => null, null, () => false, null);
        ...
        public void when_schema_is_null_schema_is_stripped_from_scripts()
        {
            ...
            var executor = new SqlServerScriptExecutor(() => new TestConnectionManager(dbConnection, true), () => new ConsoleUpgradeLog(), null, () => true, null);
        ...
        public void does_not_use_variable_subtitute_preprocessor_when_setting_false()
        {
            ...
            var command = Substitute.For<IDbCommand>();
            dbConnection.CreateCommand().Returns(command);
            var executor = new SqlServerScriptExecutor(() => new TestConnectionManager(dbConnection, true), () => new ConsoleUpgradeLog(), null, () => false, null);
        ...
        public void uses_variable_subtitutes_schema()
        {
            ...
            var command = Substitute.For<IDbCommand>();
            dbConnection.CreateCommand().Returns(command);
            var executor = new SqlServerScriptExecutor(()=>new TestConnectionManager(dbConnection, true), () => new ConsoleUpgradeLog(), "foo", () => true, null);
