...
namespace DbUp.Tests.Oracle
{
    public class OracleTableJournalTests
    {
        ...
        public void constructing_table_journal_with_null_table_or_schema_parameter_values_throws_argument_null_reference_exception(string schema, string table)
        {
            ...
            new OracleTableJournal(() => connection, () => logger, schema, table);
        }

        [Test]
        [ExpectedException(typeof(ArgumentNullException))]
        public void constructing_table_journal_with_null_connection_manager_throws_argument_null_reference_exception()
        {
            var logger = Substitute.For<IUpgradeLog>();
            new OracleTableJournal(null, () => logger, "schema", "table");
        }
        ...
        {
            new OracleTableJournal(() => null, null, "schema", "table");
        }
        ...
        public void storing_executed_script_checks_if_journal_table_already_exists()
        {
            ...
            Func<IDbCommand> doesTableExistCommand = () => connectionManager.Commands.First();
            var logger = Substitute.For<IUpgradeLog>();

            connectionManager.UpgradeStarting(logger);

            var tableJournal = new OracleTableJournal(() => connectionManager, () => logger, "TEST_DBUP_SCHEMA", "TEST_SCHEMA_VERSION_TABLE");
        ...
        //    var tableJournal = new OracleTableJournal(() => connection, () => logger, "TEST_DBUP_SCHEMA", "TEST_SCHEMA_VERSION_TABLE");
